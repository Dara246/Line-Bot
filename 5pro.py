...
kr1 = KRIS.LINE()
kr1.login(qr=True)
kr1.login(token="EpXJWIIv6VUH9cBFMpRe.FAcxPzQ9Vx0pe+YYhHSvZG.Ea1J4KziTD2pM5tQAN1nHdW/KjqnSK8J864yjaVwiUo=")#1
kr1.loginResult()

kr2 = KRIS.LINE()
#kr2.login(qr=True)
kr2.login(token="EpRgEBEloSbgzt49eOF3.njpVw87HfgBdls4XEGeHSW.mXvTqmQL+DCjSN1DVmCS7zXIfYTuugx3y3/snorliXE=")#2
kr2.loginResult()

kr3 = KRIS.LINE()
#kr3.login(qr=True)
kr3.login(token="EpiBruS5ajwwlyiH6Gq4.L4LcdvW8qnzdUvv+wM8Yza.Lpm0cboJIiCiNUZZeJ3Nv4LSGmyjKzfvZrsVuUaAKGw=")#3
kr3.loginResult()

kr4 = KRIS.LINE()
#kr4.login(qr=True)
kr4.login(token="EpA7VCEch16t3bvPykY6.a/bZ0Ij6MpU3J0E4fMGKDG.r0p0SrYcYZkf0MoopaLKcVH/CRIhtccD077Z9vI/AmY=")#4
kr4.loginResult()

kr5 = KRIS.LINE()
#kr5.login(qr=True)
kr5.login(token="Epeavi2jKtkXZnIql4Ke.WKfQFLNYkcNd40Yjxut+tG.YqcLGcW+sthILvyMnjpPutKlQm9LQSNzq11G62FA8UU=")#5
kr5.loginResult()
...
owner=["ud24af29f208067b4451e21ef2b1d072c","ub807586941370c04ec9258caa6a798e1"]
admin=["ud24af29f208067b4451e21ef2b1d072c","ub807586941370c04ec9258caa6a798e1",mid,mid2,mid3,mid4,mid5]
